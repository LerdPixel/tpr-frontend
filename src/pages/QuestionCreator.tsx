...
const questionTypes = {
  ...
  multiple_choice: ["Несколько вариантов", "Создание вопроса с несколькими ответами"],
...
const QuestionCreator: React.FC<QuestionCreatorProps> = ({saveQuestion, modalData, setModalData}) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <button className={styles.createButton} onClick={handleSave}>Сохранить вопрос</button>
